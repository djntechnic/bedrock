...
-- Seed platform configuration keys (bedrock#50)
-- Keys read by bedrock-api platform services must be discoverable and editable in admin console.
-- Note: jwt_secret is intentionally excluded here as secrets must not reside in editable UI config.
