...
const SelectContent = React.forwardRef(({ className, children, position = "item-aligned", align = "center", ...props }, ref) => /* @__PURE__ */ jsx(Select$1.Portal, { children: /* @__PURE__ */ jsxs(
  Select$1.Content,
  {
    ref,
