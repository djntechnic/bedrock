 ...
 */
export declare function registerCommandRoutes(items: CommandRouteItem[]): void;
/** @returns The registered destinations (empty when nothing registered). */
export declare function getCommandRoutes(): CommandRouteItem[];
/** Test helper: drops the registration. Not used by application code. */
export declare function __clearCommandRoutes(): void;
