 ...
 * @description Platform-side health dashboard providing Overview metrics,
 *              API Routes explorer, and interactive OpenAPI Spec (Swagger) tabs.
 *
...
import ApiSpecPanel from "./ApiSpecPanel";
...
export default function PlatformHealthPanel({
  ...
  const [activeSection, setActiveSection] = useState<"overview" | "routes" | "spec">(defaultSection);
