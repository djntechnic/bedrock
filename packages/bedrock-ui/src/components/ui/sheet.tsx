...
const sheetVariants: Record<string, string> = {
  ...
  bottom:
    "inset-x-0 bottom-0 border-t data-open:slide-in-from-bottom-10 data-closed:slide-out-to-bottom-10",
  left: "inset-y-0 left-0 h-full w-3/4 sm:max-w-sm border-r data-open:slide-in-from-left-10 data-closed:slide-out-to-left-10",
  right:
    "inset-y-0 right-0 h-full w-3/4 sm:max-w-sm border-l data-open:slide-in-from-right-10 data-closed:slide-out-to-right-10",
};
