 ...
 */
export type ColumnCellRenderer = (
  value: unknown,
  row: Record<string, unknown>,
  options?: CellRenderOptions,
) => ReactNode;

const mediaRenderers = new Map<string, MediaCellRenderer>();
const columnRenderers = new Map<string, ColumnCellRenderer>();
 ...
 */
export function registerMediaRenderer(
  cellType: string,
  render: MediaCellRenderer,
): void {
 ...
 */
export function resolveMediaRenderer(
  cellType: string | null | undefined,
): MediaCellRenderer | undefined {
 ...
 */
export function resolveColumnRenderer(
  columnId: string | null | undefined,
): ColumnCellRenderer | undefined {
 ...
 */
export function getMediaCellTypes(): Set<string> {
 ...
 */
export function isMediaCellType(cellType: string | null | undefined): boolean {
  return resolveMediaRenderer(cellType) !== undefined;
}

/** Test helper: drops every registration. Not used by application code. */
export function __clearCellRegistry(): void {
